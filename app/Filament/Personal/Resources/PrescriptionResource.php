...
use App\Filament\Personal\Resources\PrescriptionResource\Pages;
use App\Filament\Personal\Resources\PrescriptionResource\RelationManagers;
...
class PrescriptionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        ...
        function calculateTotalValues(Set $set, Get $get) {
            $payment = $get('value_received') * 0.10;
