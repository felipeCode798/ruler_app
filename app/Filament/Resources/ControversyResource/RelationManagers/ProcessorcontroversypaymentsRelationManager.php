...
class ProcessorcontroversypaymentsRelationManager extends RelationManager
{
    protected static string $relationship = 'processorcontroversypayments';
    protected static ?string $title = 'Crear Pago de Comision';
