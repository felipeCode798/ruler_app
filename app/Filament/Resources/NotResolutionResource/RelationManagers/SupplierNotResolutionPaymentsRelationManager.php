...
namespace App\Filament\Resources\NotResolutionResource\RelationManagers;
...
class SupplierNotResolutionPaymentsRelationManager extends RelationManager
{
    protected static string $relationship = 'suppliernotresolutionpayments';
