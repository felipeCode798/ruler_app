...
namespace App\Filament\Resources\PaymentAgreementResource\RelationManagers;
...
class PaymentagreementpaymentsRelationManager extends RelationManager
{
    protected static string $relationship = 'paymentagreementpayments';
