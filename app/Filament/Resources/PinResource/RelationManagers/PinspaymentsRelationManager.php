...
namespace App\Filament\Resources\PinResource\RelationManagers;
...
class PinspaymentsRelationManager extends RelationManager
{
    protected static string $relationship = 'pinspayments';
