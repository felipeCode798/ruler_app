...
namespace App\Filament\Resources\RenewallResource\RelationManagers;
...
class SupplierRenewallPaymentsRelationManager extends RelationManager
{
    protected static string $relationship = 'supplierrenewallpayments';
