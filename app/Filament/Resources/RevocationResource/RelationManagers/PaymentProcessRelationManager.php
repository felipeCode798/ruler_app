...
namespace App\Filament\Resources\RevocationResource\RelationManagers;
...
class PaymentProcessRelationManager extends RelationManager
{
    protected static string $relationship = 'PaymentProcess';
