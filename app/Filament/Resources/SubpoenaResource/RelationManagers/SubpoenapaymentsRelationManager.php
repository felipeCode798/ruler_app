...
namespace App\Filament\Resources\SubpoenaResource\RelationManagers;
...
class SubpoenapaymentsRelationManager extends RelationManager
{
    protected static string $relationship = 'subpoenapayments';
