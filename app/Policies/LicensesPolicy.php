...
class LicensesPolicy
{
     ...
     */
    public function view(User $user, Licenses $licenses): bool
    {
     ...
     */
    public function update(User $user, Licenses $licenses): bool
    {
     ...
     */
    public function delete(User $user, Licenses $licenses): bool
    {
     ...
     */
    public function forceDelete(User $user, Licenses $licenses): bool
    {
     ...
     */
    public function restore(User $user, Licenses $licenses): bool
    {
     ...
     */
    public function replicate(User $user, Licenses $licenses): bool
    {
