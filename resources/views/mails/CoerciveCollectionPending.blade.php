...
<head>
    ...
    <title>Controversy Pending</title>
</head>
<body>
    <h1>Controversy Pending</h1>
    <p>Se generó un proceso de controversia para el cliente {{ $data['client'] }}</p>
    <p>El proceso de controversia se encuentra en estado pendiente.</p>
    <p>Se contempla una cita para el día {{ $data['appointment'] }}.</p>
    <p>Su código es {{ $data['code'] }} y la ventana es {{ $data['window'] }}.</p>
</body>
</html> --}}
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 38px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 14px; font-weight: 400;"><span>Creado: <strong>{{ $data['created_at'] }}</strong></span></h1>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 11px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 14px; font-weight: 400;">Proceso de Cobro Coactivo</h1>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
