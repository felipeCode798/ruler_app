                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 38px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 14px; font-weight: 400;"><span>Fecha Inicio: <strong>{{ $data['created_at'] }}</strong></span></h1>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 20px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 180%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 180%;"><span style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 25.2px;">Se informa al usuario <strong>{{ $data['client_name'] }}</strong> que ha empezado un proceso de controversia con <strong>Ruler Soluciones de transito</strong>, debe tener en cuenta que el usuario <strong>{{ $data['client_name'] }}</strong> Identificado con el numero de documento <strong>{{ $data['client_dni'] }}</strong>los pocesos pueden pueden demorar 5 a 20 dias habailes dependiendo de la solitud que deba realizar</span><span style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 25.2px;"></span></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 30px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;">Puedes descargar la factura de haciendo click en el boton</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <div class="v-text-align" align="center">
                                                                <a href="{{ $data['pdf_url'] }}" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #000000; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                                                <span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Descargar Factura</span></span>
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
