...
<body>
    <h1>Información de Revocatoria</h1>
    <p><strong>Cliente:</strong> {{ $data['client'] }}</p>
    <p><strong>Cédula:</strong> {{ $data['dni'] }}</p>
    <p><strong>Email:</strong> {{ $data['email'] }}</p>
    <p><strong>Teléfono:</strong> {{ $data['phone'] }}</p>
    <p><strong>Factura:</strong> {{ $data['invoice'] }}</p>
    <p><strong>Tramitador:</strong> {{ $data['processor_id'] }}</p>
    <p><strong>Valor Total:</strong> {{ $data['grand_value'] }}</p>
    <p><strong>Estado:</strong> {{ $data['status'] }}</p>
    <p><strong>Observaciones:</strong> {{ $data['observations'] }}</p>
    <p><strong>Pagado:</strong> {{ $data['paid'] ? 'Sí' : 'No' }}</p>
    ...
    <head>
        ...
        <style type="text/css">
            @media only screen and (min-width: 620px) {
                ...
                .u-row .u-col-31p67 { width: 190.02px !important; }
                .u-row .u-col-33p33 { width: 199.98px !important; }
                .u-row .u-col-35 { width: 210px !important; }
            ...
            @media (max-width: 620px) {
                ...
                .no-stack .u-col-31p67 { width: 31.67% !important; }
                .no-stack .u-col-33p33 { width: 33.33% !important; }
                .no-stack .u-col-35 { width: 35% !important; }
                .no-stack .u-col-66p67 { width: 66.67% !important; }
            }
                                            ...
                                            <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                                ...
                                                <table id="u_content_heading_4" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:12px 10px 38px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 14px; font-weight: 400;"><span>Total: <strong>$ {{ $data['grand_value'] }}</strong></span></h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 11px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 14px; font-weight: 400;">Proceso de Revocatoria</h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 14px; font-weight: 400;"><span><strong>$ {{ $data['grand_value'] }}</strong></span></h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                                <table id="u_content_heading_15" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 18px; font-weight: 400;"><span><strong>$ {{ $data['grand_value'] }}</strong></span></h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                        ...
                                                        <tr>
                                                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 20px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 180%; text-align: center; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 180%;"><span style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 25.2px;">Se informa al usuario <strong>{{ $data['client'] }}</strong> que ha empezado un proceso de revocatoria con <strong>Ruler Soluciones de transito</strong>, debe tener en cuenta que el usuario <strong>{{ $data['client'] }}</strong> Identificado con el numero de documento <strong>{{ $data['dni'] }}</strong></span><span style="font-family: Montserrat, sans-serif; font-size: 14px; line-height: 25.2px;"></span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
